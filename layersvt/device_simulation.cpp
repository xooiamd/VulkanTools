...
class JsonLoader {
   ...
   private:
    ...
    static bool WarnNever(const char *, const uint32_t, const uint32_t) { return false; }
    ...
    void GetValue(const Json::Value &parent, const char *name, float *dest,
                  std::function<bool(const char *, float, float)> warn_func = WarnNever) {
    ...
    void GetValue(const Json::Value &parent, const char *name, int32_t *dest,
                  std::function<bool(const char *, int32_t, int32_t)> warn_func = WarnNever) {
        const Json::Value value = parent[name];
    ...
    void GetValue(const Json::Value &parent, const char *name, uint32_t *dest,
                  std::function<bool(const char *, uint32_t, uint32_t)> warn_func = WarnNever) {
        const Json::Value value = parent[name];
        if (value.type() != Json::intValue) {
            return;
        }
    ...
    void GetValue(const Json::Value &parent, const char *name, uint64_t *dest,
                  std::function<bool(const char *, uint64_t, uint64_t)> warn_func = WarnNever) {
        const Json::Value value = parent[name];
        if (value.type() != Json::intValue) {
            return;
        }
    ...
    void GetValue(const Json::Value &parent, const char *name, T *dest,
                  std::function<bool(const char *, T, T)> warn_func = WarnNever) {
        const Json::Value value = parent[name];
        if (value.type() != Json::intValue) {
            return;
        }
